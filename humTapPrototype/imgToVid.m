...
- (void)createVideo:(NSMutableArray*)imgArr andAudio:(NSString*)audioFile {
    ...
    NSMutableArray *imageArray = imgArr;
    CGSize imageSize = CGSizeMake(400, 533);
    NSUInteger fps = 30;
    ...
    // audio input file...
    NSString *audio_inputFilePath = [bundleDirectory stringByAppendingPathComponent:@"pakistan.mp3"];
